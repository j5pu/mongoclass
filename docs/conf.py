...
html_theme = "furo"
html_title, html_last_updated_fmt = "mongodata docs", "%Y-%m-%dT%H:%M:%S"
inheritance_alias = {}
nitpicky = True
...
extlinks = {
    "issue": ("https://github.com/j5pu/mongodata/issues/%s", "#%s"),
    "pull": ("https://github.com/j5pu/mongodata/pull/%s", "PR #%s"),
